...
public class Solution {
    ...
    public static final String UNIC_BINDING_NAME1 = "cat.entity";
    public static final String UNIC_BINDING_NAME2 = "dog.entity";
    ...
    public static Thread SERVER_THREAD = new Thread(new Runnable() {
        ...
        public void run() {
            ...
            try {
                final Cat cat = new Cat("Cat1");
                final Dog dog = new Dog("Dog1");
