...
public class Solution {
    public static void main(String[] args) {
        ...
        System.out.println(cat.getClass()); //System.out.println(Cat.class);  class com.javarush.task.task35.task3507.data.Cat
        System.out.println(Cat.class.getClassLoader()); // jdk.internal.loader.ClassLoaders$AppClassLoader@4b1210ee
