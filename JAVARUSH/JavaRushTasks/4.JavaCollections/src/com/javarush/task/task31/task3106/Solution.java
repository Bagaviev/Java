...
public class Solution {
    public static void main(String[] args) throws IOException {
        ...
        List<String> fileNamePart = new ArrayList<>(Arrays.asList(args)).subList(1, args.length);
        ...
        try (FileOutputStream fos = new FileOutputStream(resultFileName);
             ZipInputStream zis = new ZipInputStream(new SequenceInputStream(Collections.enumeration(inputStreams))))  // old iterator version итератор
        {
