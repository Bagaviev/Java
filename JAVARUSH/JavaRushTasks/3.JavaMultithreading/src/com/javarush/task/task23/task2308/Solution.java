...
public class Solution {
    public final static class Constants {
        ...
        public final static String USER_IS_NOT_AUTHORIZED = "The server is currently not accessible.";
        public final static String USER_IS_BANNED = "The user is not authorized.";
        public final static String ACCESS_IS_DENIED = "The user is not authorized.";
    }
